...
model_1= model_2# tf.keras.models.load_model("./tiny_bert/")#load_model_from_github('https://github.com/sebastianArango99/sentiment_analysis_app/blob/main/modelo_bert/saved_model.pb')#tf.saved_model.load("./modelo_bert/")
...
if st.button('Analizar Fragmento'):
    ...
    if user_input:
        ...
        prediction_1 =model_2.predict(prepared_input)#(input_text)# serving_default(**tokenizer.encode_plus(input_text, return_tensors="tf"))
        ...
        st.write('Resultado del Modelo 1 (LSTM): ', label1)
